...
# No blanket SSH egress: git goes over HTTPS via gh, and an open :22 to
# anywhere is a generic tunnel out of an otherwise allowlisted box. GitHub's
# SSH endpoints are covered by the ipset below if ever needed.
# Allow localhost
