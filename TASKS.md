...
- **design-phase2-extension** — orchestrator task, not a worker spawn: extend design/ for the Phase 2 surfaces (Lessons-insights browsing, Ask button + chat thread screen, Suggestions screen, voice-question recording affordance) — the known deliberate gap from DECISIONS.md 2026-06-10. Must be committed before any Phase-2 UI task spawns [Must — Phase 2 pre-task]
