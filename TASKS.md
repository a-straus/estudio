...
- **library-mobile-separator**: `/library` SegmentedControl wraps to 2×2 on mobile with no divider between rows; add the row separator using existing tokens. Owns the shared SegmentedControl component + CSS only. (spawned: 2026-06-11 iter 63, `--model sonnet`)
