...
- **sm2-engine**: /server/src/srs/ pure functions — SM-2 grade application, manual demotion, maturity ≥21d, review queue builder with new-cards/day promotion; exhaustive unit tests; new files only, touches no existing file (spawned: 2026-06-11 18:25, `--model "$ORCH_MODEL" --effort high`, schema excerpts pasted in brief)
